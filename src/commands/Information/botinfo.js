  ...
  async run({ message, args, prefix, author }, t) {
    ...
    const EMBED = new ClientEmbed(author)
      ...
      .addFields(
        {
          name: "Meu Dono",
          value: `**${owner.tag}** || **[${owner.username}](https://twitter.com/flower_vp)**`,
        },
        {
        ...
        {
          name: `Meus Links`,
          value: `[Meu Convite](https://discord.com/oauth2/authorize?client_id=764504765509926918&permissions=20887631278&scope=bot)\n[Servidor de Suporte](https://discord.gg/zpZxyMZQ)`,
        }
      )
      .setThumbnail(
